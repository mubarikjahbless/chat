...
class CreateChannelDTO {
    constructor() {
        this.type = chat_channel_type_1.ChatChannelType.PUBLIC;
    }
}
...
__decorate([
    ...
    (0, class_validator_1.MinLength)(5, { message: 'name too short minimum should be 5 charactors' }),
    (0, class_validator_1.MaxLength)(20, { message: 'name too long maximum should be 20 charactors' }),
